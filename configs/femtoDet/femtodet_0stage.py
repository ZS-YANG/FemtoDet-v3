...
pretrain_weight = './weights/weights/femtodet_nano_backbone_pretrained_model_witc_cd_conv2_4973.pth'
load_from = None
resume_from = None
# more information
optimizer = dict(
...
log_config = dict(interval=50, hooks=[dict(type='TextLoggerHook')])  # default_hooks
custom_hooks = [
...
headfeat_channel = 64
# custom_imports = dict(imports=['build/lib/mmdet/models/detectors/femtodet'], allow_failed_imports=False)
...
train_dataset = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='E:\\datasets\\VOC\\coco\\voc07_train.json',
        img_prefix='E:\\datasets\\VOC\\VOCdevkit',
        pipeline=[
...
data = dict(
    ...
    val=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='E:\\datasets\\VOC\\coco\\voc07_val.json',
        img_prefix='E:\\datasets\\VOC\\VOCdevkit',
        pipeline=test_pipeline),
    test=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='E:\\datasets\\VOC\\coco\\voc07_test.json',
        img_prefix='E:\\datasets\\VOC\\VOCdevkit',
        pipeline=test_pipeline))
